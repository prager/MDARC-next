...
$routes->get('admin-faqs', 'Admin::master_faqs');
...
$routes->get('admin-add-mem', 'Admin::add_mem');
...
$routes->get('print-dir', 'Staff::print_dir');
$routes->get('print-callsigns', 'Staff::print_callsigns');
