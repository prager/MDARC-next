          ...
          <div class="row">
            <div class="col-lg-4">
                <?php if($forYear != 0 && $forYear != 99) { ?>
                  <a href="<?php echo base_url() . 'index.php/staff-members'; ?>" class="text-decoration-none"><h4 class="mb-1 text-warning">Current Members (for Staff)</h4></a>
                    <p> Total of <?php echo $numMems; ?> members. Click for <a href="<?php echo base_url() . 'index.php/staff-all-members'; ?>" class="text-decoration-none">All Members</a></p>
                <?php } else { ?>
                    <h4 class="mb-1">All Members</h4>
                    <p>Total of <?php echo $numMems; ?> members. Click for <a href="<?php echo base_url() . 'index.php/staff-members'; ?>" class="text-decoration-none">Current Members</a> only</p>
                <?php } ?>
            </div>
                      ...
                      <table class="table table-sm table-striped align-middle mb-0">
                        ...
                        <tr>
                          ...
                          <?php foreach ($columns as $col => $label):
                              ...
                              if($forYear != 0) {
                                  $link     = site_url('staff-members?sort=' . $col . '&dir=' . $arrowDir . '&page=' . (int)($page));
                              }
                              else {
                                  $link     = site_url('staff-all-members?sort=' . $col . '&dir=' . $arrowDir . '&page=' . (int)($page));
                              }
                          ?>
                            <th>
                            <?= esc($label) ?>
