    ...
    <div class="container">
        <div class="row align-items-center justify-content-between mt-5">
            ...
            <div class="col-md offset-md-1">
              ...
              <p>Edit MDARC Members: <a href="<?php echo base_url() . 'index.php/staff-members'; ?>" class="text-decoration-none">MDARC Members</a></p>
              <!-- <p>Add MDARC Member: <a href="<?php echo base_url() . 'index.php/admin-add-mem'; ?>" class="text-decoration-none">Add a Member</a></p> -->
              <p>Print Directory View - <a href="<?php echo base_url() . 'index.php/print-dir'; ?>" class="text-decoration-none">by Last Name</a></p>
              <p>Print Directory View - <a href="<?php echo base_url() . 'index.php/print-callsigns'; ?>" class="text-decoration-none">by Callsign</a></p>
